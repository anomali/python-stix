...
XML_NS_Assertion = "http://www.us-cert.gov/sites/default/files/STIX_Namespace/ISAMarkingsAssertionsType.v2.xsd"
...
class ISAMarkingAssertionsStructureType(data_marking_binding.MarkingStructureType):
    ...
    '''
    xmlns = XML_NS_Assertion
    xmlns_prefix = "edh2cyberMarkingAssert"
...
class AccessPrivilegeType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        if nodeName_ == 'privilegescope':
            ...
            privilegescope = self.gds_validate_string(privilegescope, node, 'privilegescope')
            self.privilegescope = privilegescope
